...
Table:new({
	...
	["cnt_evts_string"] = "";
	["ref_cycles_rate"] = 0;
	["exe_path"] = "/home/user/macao-kitchen/driver_python_c/python_test/OV1_python/binaries/python3";
	["node_MB_RAM"] = 0;
	["max_processes"] = 0;
	["use_OS_timers"] = false;
	...
	["smp_evts_profiles"] = "";
	["libs_to_disass"] = "my_functions.so";
	["mute"] = false;
	["smp_evts_string"] = "";
	["backtrace_mode"] = 1;
	["user_guided"] = -1;
	["kill_signals"] = "";
	["experiment_path"] = "/home/user/macao-kitchen/driver_python_c/python_test/OV1_python/tools/lprof_npsu_run_0";
	["ign_signals"] = "";
	["cpu_clock_rate"] = 0;
